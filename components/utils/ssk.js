    ...
    .then(data => {
        ...
        data.forEach(candidate => {
            ...
            <div class="p-2 sm:p-3 md:p-4">
                ...
                <button 
                    class="watch-video-link w-full bg-gradient-to-r from-pink-300 via-purple-300 to-cyan-300 text-white rounded-full py-1.5 sm:py-2 px-3 sm:px-4 flex items-center justify-center gap-1 sm:gap-2 transition-colors text-xs sm:text-sm" 
